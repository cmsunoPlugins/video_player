...
if (isset($_POST['action']))
	...
	switch ($_POST['action'])
		...
		<div class="blocForm">
			...
			<p><?php echo _("The YouTube button") .'<img src="uno/plugins/video_player/youtube/images/icon.png" style="border:1px solid #aaa;padding:3px;margin:0 6px -5px;border-radius:2px;" />' . _("is also added to the toolbar to insert a youtube video.");?></p>
			<div class="clear"></div>
		</div>
		<?php break;
		// ********************************************************************************************
